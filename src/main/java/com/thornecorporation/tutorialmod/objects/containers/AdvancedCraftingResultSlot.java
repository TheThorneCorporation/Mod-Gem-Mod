...
public class AdvancedCraftingResultSlot extends Slot {
	   private final AdvancedCraftingInventory field_75239_a;
	   private final PlayerEntity player;
	   private int amountCrafted;

	   public AdvancedCraftingResultSlot(PlayerEntity player, AdvancedCraftingInventory craftingInventory, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition) {
	   ...
	   public ItemStack onTake(PlayerEntity thePlayer, ItemStack stack) {
	      ...
	      NonNullList<ItemStack> nonnulllist = thePlayer.world.getRecipeManager().getRecipeNonNull(IThorneRecipeType.ADVANCED_CRAFTING, this.field_75239_a, thePlayer.world);
