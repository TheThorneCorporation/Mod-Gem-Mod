...
public class AdvancedCraftingInventory implements IInventory, IRecipeHelperPopulator {
	   private final NonNullList<ItemStack> stackList;
	   private final int width;
	   private final int height;
	   private final Container container;
	
	   public AdvancedCraftingInventory(Container eventHandlerIn, int width, int height) {
